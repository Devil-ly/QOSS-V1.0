...
QPaint2DField::QPaint2DField(QWidget *parent) :
	 QLabel(parent)
{
	NumOfLength = 250;
	NumOfWidth = 250;
...
void QPaint2DField::paintEvent(QPaintEvent * event)
{
...
void QPaint2DField::setData(vector <vector <double>> & _data)
{
	data = _data;
}

void QPaint2DField::setNum(int n, int m)
{
	NumOfLength = n;
	NumOfWidth = m;
}

void QPaint2DField::calcData(vector<vector<complex<double>>>& Ex, vector<vector<complex<double>>>& Ey)
{
