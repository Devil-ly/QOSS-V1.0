...
#ifndef SOURCEMODEGENERATION_H  // 全大写
#define SOURCEMODEGENERATION_H
...
{ // 命令空间 避免命名重复
	...
	class SourceModeGeneration //类名保持和头文件名字相同
	{
	public:
		SourceModeGeneration
		...
		bool GetCircularWaveguideProperty(double &phi1,double &theta1,double &Rc);
